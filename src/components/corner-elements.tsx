const CornerElements = () => {
  return (
    <>
      ...
      <div className='absolute bottom-0 left-0 w-4 h-4 border-l border-b border-primary/40' />
      <div className='absolute bottom-0 right-0 w-4 h-4 border-r border-b border-primary/40' />
    </>
  );
};
