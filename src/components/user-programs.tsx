      ...
      <div className='container mx-auto max-w-6xl px-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          {USER_PROGRAMS.map((program) => (
            <Card
              key={program.id}
              className='bg-card/90 backdrop-blur-sm border border-border hover:border-primary/50 transition-colors overflow-hidden flex flex-col h-full'
            >
        ...
        <div className='mt-16 text-center'>
          <Link href='/generate-program'>
            <Button
              size='lg'
              className='bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-6 text-lg hover:text-white'
            >
              Generate Your Program
              <Sparkles className='ml-1 h-5 w-5 hover:text-white' />
            </Button>
          </Link>
